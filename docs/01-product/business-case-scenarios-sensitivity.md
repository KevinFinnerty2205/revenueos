...
Oryntela does not infer, randomise or optimise scenario values. Model presets, when configured, are visible suggestions rather than hidden coefficients. Approval covers every included scenario.
