# Oryntela identity — third-party licence record
...
- **Local licence copy:** [`GEIST-OFL-1.1.txt`](GEIST-OFL-1.1.txt)
- **Spend:** AUD $0
...
None. The mark, layouts, mockups and raster derivatives were created for Oryntela.
No stock symbol, logo-generator output, competitor artwork, customer asset or
remote runtime dependency is included.
