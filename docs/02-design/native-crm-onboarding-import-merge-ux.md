...
Confirmation uses the text: “The duplicate record will be archived and its supported relationships moved to the record you keep. Historical provenance will remain. This cannot be undone from Oryntela.” There is no batch merge, fuzzy auto-merge or user undo.
