...
Organisation export version 25 serialises the core fields, archive timestamps, CRM
setting, field definitions, typed values, record changes, Pipeline definitions/current
assignment, immutable stage events and closure metadata. Values remain structured and
