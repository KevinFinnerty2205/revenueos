...
WO-004A1 originally added persistence only. WO-004C1–C6 and WO-006A/006B now reuse it
for Executive Summary, Buying Signals, Objections & Competitive Signals,
...
- the allowed `infrastructure_test`, `executive_summary`, `buying_signals`, `objections_competitive_signals`, `decisions`, `action_items`, `risks_blockers`, `open_questions` or `follow_up_email` job type and lifecycle state;
