...
WO-004A1 originally added persistence only. WO-004C1/C1A/C2 now reuse it for
Executive Summary and Decisions generated by the configured mock or OpenAI
provider; see [Executive Summary intelligence](executive-summary-intelligence.md)
and [Meeting Decisions intelligence](meeting-decisions-intelligence.md).
...
- the allowed `infrastructure_test`, `executive_summary` or `decisions` job type and lifecycle state;
...
- Only infrastructure-test, Executive Summary and Decisions behaviour exists.
- OpenAI is optional; no Action Items or later intelligence capability exists.
