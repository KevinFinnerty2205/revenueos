...
WO-004A1 originally added persistence only. WO-004C1–C6 and WO-006A/006B/006C now reuse it
for Executive Summary, Buying Signals, Objections & Competitive Signals, Stakeholder Intelligence,
Decisions, Action Items, Risks & Blockers,
Open Questions and Follow-up Email generated by the configured
...
and [Buying Signals & Deal Momentum intelligence](buying-signals-intelligence.md).
See also [Objections & Competitive Signals intelligence](objections-competitive-signals-intelligence.md).
See also [Stakeholder Intelligence](stakeholder-intelligence.md).
...
- the allowed `infrastructure_test`, `executive_summary`, `buying_signals`, `objections_competitive_signals`, `stakeholder_intelligence`, `decisions`, `action_items`, `risks_blockers`, `open_questions` or `follow_up_email` job type and lifecycle state;
...
Revision `0013_buying_signals` widens only the job and artefact type checks for
Buying Signals. Its downgrade deletes those rows before restoring the Follow-up
Email-era checks and preserves the same tenant keys, forced RLS and indexes.

Revision `0014_objections` widens only those checks for Objections & Competitive
Signals. Its downgrade deletes those rows before restoring the Buying
Signals-era checks and preserves the same tenant keys, forced RLS and indexes.

Revision `0015_stakeholders` widens only those checks for Stakeholder
Intelligence. Its downgrade deletes only those artefacts/jobs before restoring
...
- Only infrastructure-test, Executive Summary, Buying Signals, Objections &
  ...
  Action Items, Risks & Blockers, Open Questions and Follow-up Email behaviour
  exists.
