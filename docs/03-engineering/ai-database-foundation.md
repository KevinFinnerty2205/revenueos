...
WO-004A1 originally added persistence only. WO-004C1/C1A now reuse it for an
Executive Summary generated by the configured mock or OpenAI provider; see
...
- Only infrastructure-test and Executive Summary behaviour exists.
- OpenAI is optional; no additional intelligence capability exists.
