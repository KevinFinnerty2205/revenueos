...
> operations is complete at repository level through `0062_live_stripe_billing`.
...
- `GET /health/ready` performs fast, bounded checks for database connectivity,
  current Alembic head (`0062_live_stripe_billing`), identity configuration, selected
