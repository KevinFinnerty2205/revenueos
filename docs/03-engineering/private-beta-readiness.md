...
> operations is complete at repository level through `0061_manual_paid_credit_grant`.
...
- `GET /health/ready` performs fast, bounded checks for database connectivity,
  current Alembic head (`0061_manual_paid_credit_grant`), identity configuration, selected
