...
Site photos are observations, not customer statements. Provider output is limited to technical constraints, implementation requirements, risks and other observed context. Every candidate uses support classification `observed`, low/medium/high confidence only when supplied, and an explicit source label.
