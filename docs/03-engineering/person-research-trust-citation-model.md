...
- `inferred`: a cautious Oryntela interpretation of cited public facts;
...
Public statements remain public Prospect research. They never acquire `customer_direct` origin and cannot support customer Evidence, Methodology, Stakeholder Intelligence, Revenue Brain or Ask Oryntela in WO-027.
