...
unset and all live Stripe references empty. The owner selected GST-inclusive fixed
customer totals on 11 September 2026, but the following sequence must still be
performed in order under separate activation authority:

1. Qualified review finalises GST-inclusive wording in the Privacy Notice/Service
   Terms and any required invoice/tax treatment; record the durable policy reference.
