...
- Export version 5 excludes storage keys, signed URLs and provider request IDs. Image bytes are omitted unless a separately approved server setting enables them for an authorised admin export.
