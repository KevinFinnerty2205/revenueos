...
The owner selected GST-inclusive fixed customer totals on 11 September 2026. Live
checkout still fails closed until qualified legal review completes and the decision
has a durable tax-policy reference.
...
| GST presentation | PASS | Official ABN Lookup confirms GST registration from 25 February 2005; owner selected GST-inclusive fixed customer totals on 11 September 2026. Public/legal implementation remains blocked pending qualified review and a durable policy reference |
...
**ACTION:** Apply the 11 September 2026 owner decision that the six fixed customer totals include GST. Qualified review must finalise consistent site, Terms, Stripe and invoice wording and supply the durable policy reference before live checkout. Live Stripe is the owner-selected subscription-payment implementation; WO-055 remains only the exceptional manual paid-Credit path. **WHY:** ABN Lookup confirms GST registration from 25 February 2005, but engineering cannot determine tax-invoice, overseas-customer or accounting treatment. **COST:** advice UNKNOWN; Stripe has AUD 0 fixed standard fee plus researched transaction/Billing fees once activated. **CARD REQUIRED:** NO for the legal review; Stripe requires business/bank verification to activate. **AUTO-RENEW:** usage-based after activation. **OWNER CREDENTIAL/ROLE:** entity/tax records, qualified adviser/accountant where required and product owner. **UNLOCKS:** truthful price/tax language and external Stripe configuration/preflight. **CAN LAUNCH WITHOUT IT:** YES for private synthetic work; NO for paid launch. **RECOMMENDATION:** complete qualified review and record the policy reference before creating live Prices or enabling checkout.
