...
export default async function SelectOrganisationPage() {
  ...
  return (
    <main className="min-h-screen bg-brand-background px-5 py-12">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <section className="form-card" aria-labelledby="organisation-title">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-600">
              Oryntela keeps every meeting and insight inside the active
              organisation. Choose an invitation or create the workspace
              approved for your beta trial.
            </p>
            <div className="mt-6">
              <OrganizationList
                hidePersonal
          ...
          >
            ...
            <p className="mt-3 text-sm leading-6 text-slate-600">
              Only create an organisation when your Oryntela beta operator has
              approved it.
            </p>
            <div className="mt-6">
              <CreateOrganization
