...
test("Closed-Won Handover lifecycle remains reviewed, source-visible and usable at 390px", async ({
  page,
}) => {
  ...
  state = "in_review";
  await page.reload();
  await expect(page.getByText("Review required before approval")).toBeVisible();
