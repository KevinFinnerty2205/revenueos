...
def test_openapi_contains_current_domain_endpoints(client: TestClient) -> None:
    ...
    assert paths == {
        ...
        "/api/v1/billing/webhooks/{provider_name}",
        "/api/v1/credits",
        ...
        "/api/v1/selling-profile",
        "/api/v1/selling-profile/context",
        "/api/v1/selling-profile/revisions",
        "/api/v1/selling-profile/revisions/{revision_id}",
        "/api/v1/selling-profile/revisions/{revision_id}/approve",
        "/api/v1/selling-profile/revisions/{revision_id}/retire",
        ...
        "/api/v1/forecast",
        "/api/v1/forecast/metadata",
        "/api/v1/forecast/calibration",
        "/api/v1/forecast/opportunities/{opportunity_id}/judgments",
        "/api/v1/forecast/opportunities/{opportunity_id}/history",
        "/api/v1/forecast/opportunities/{opportunity_id}/manager-judgments",
        "/api/v1/forecast/opportunities/{opportunity_id}/manager-history",
        "/api/v1/manager/deal-attention",
        "/api/v1/manager/opportunities/{opportunity_id}",
        ...
        "/api/v1/opportunities/{opportunity_id}/deal-room",
        "/api/v1/opportunities/{opportunity_id}/deal-room/draft",
        "/api/v1/opportunities/{opportunity_id}/deal-room/publish",
        "/api/v1/opportunities/{opportunity_id}/deal-room/pause",
        "/api/v1/opportunities/{opportunity_id}/deal-room/revoke",
        "/api/v1/opportunities/{opportunity_id}/deal-room/rotate-link",
        "/api/v1/opportunities/{opportunity_id}/handover",
        "/api/v1/opportunities/{opportunity_id}/handover/prepare",
        "/api/v1/opportunities/{opportunity_id}/handover/revisions/{revision_id}",
        "/api/v1/opportunities/{opportunity_id}/handover/revisions/{revision_id}/draft",
        "/api/v1/opportunities/{opportunity_id}/handover/revisions/{revision_id}/confirm-claim",
        "/api/v1/opportunities/{opportunity_id}/handover/revisions/{revision_id}/submit",
        "/api/v1/opportunities/{opportunity_id}/handover/revisions/{revision_id}/refresh-sources",
        "/api/v1/opportunities/{opportunity_id}/handover/revisions/{revision_id}/approve",
        "/api/v1/opportunities/{opportunity_id}/handover/revisions/{revision_id}/retire",
        "/api/v1/deal-rooms/public/resolve",
        "/api/v1/deal-rooms/public/resources/{resource_id}/download",
        ...
        "/api/v1/integrations/salesforce/oauth/start",
        ...
        "/api/v1/integrations/microsoft/connections/{connection_id}/sync",
        "/api/v1/integrations/microsoft/connections/{connection_id}/sync-status",
        "/api/v1/integrations/microsoft/replies",
        "/api/v1/integrations/microsoft/calendar/events",
        "/api/v1/integrations/microsoft/calendar/events/{event_id}/interaction",
        "/api/v1/integrations/google/oauth/start",
        "/api/v1/integrations/google/oauth/callback",
        "/api/v1/integrations/google/connections/{connection_id}/sync",
        "/api/v1/integrations/google/connections/{connection_id}/sync-status",
        "/api/v1/integrations/google/replies",
        "/api/v1/integrations/google/calendar/events",
        "/api/v1/integrations/google/calendar/events/{event_id}/interaction",
        ...
        "/api/v1/integrations/connections/{connection_id}/crm/status",
        "/api/v1/integrations/connections/{connection_id}/crm/enabled",
        "/api/v1/integrations/connections/{connection_id}/crm/sync",
        "/api/v1/integrations/connections/{connection_id}/crm/mappings/review",
        "/api/v1/integrations/connections/{connection_id}/crm/writeback",
        "/api/v1/integrations/connections/{connection_id}/crm/owners",
        "/api/v1/integrations/connections/{connection_id}/crm/conflicts",
        "/api/v1/integrations/crm/conflicts/{conflict_id}/resolve",
        "/api/v1/integrations/connections/{connection_id}/crm/writeback/preview",
        "/api/v1/integrations/connections/{connection_id}/crm/writeback/confirm",
        "/api/v1/integrations/connections/{connection_id}/crm/writeback/receipts/{receipt_id}/reconcile",
