    ...
    if definition.exclude_existing_accounts and relationship_state != ProspectRelationshipState.NEW_PROSPECT:
        reasons.append(
            MatchReason(
                ...
                state="excluded",
                text="An exact-domain Oryntela CRM Account exists and this market excludes existing Accounts.",
        ...
        reasons.append(
            MatchReason(
                ...
                state="context",
                text="An active Oryntela CRM Opportunity already exists for this exact-domain Account.",
                data_origin="existing_revenueos_data",
                trust_state=ProspectTrustState.VERIFIED,
                observed_value_class=relationship_state.value,
            )
        ...
        reasons.append(
            MatchReason(
                ...
                criterion_key="relationship_state",
                state="context",
                text="An exact-domain Oryntela CRM Account exists with no active Opportunity.",
                data_origin="existing_revenueos_data",
                trust_state=ProspectTrustState.VERIFIED,
                observed_value_class=relationship_state.value,
            )
