...
class AIJob(TimestampMixin, Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "job_type IN ('infrastructure_test', 'executive_summary', 'decisions', 'action_items', 'risks_blockers', 'open_questions', 'buying_signals', 'objections_competitive_signals', 'follow_up_email')",
...
class AIArtifact(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "artifact_type IN ('infrastructure_test', 'executive_summary', 'decisions', 'action_items', 'risks_blockers', 'open_questions', 'buying_signals', 'objections_competitive_signals', 'follow_up_email')",
