...
CONNECTOR_DEFINITIONS: dict[ConnectorKey, ConnectorDefinition] = {
    ...
    ConnectorKey.HUBSPOT: ConnectorDefinition(
        ...
        capabilities=(
            ConnectorCapability.SYNC_ACCOUNTS,
            ConnectorCapability.SYNC_CONTACTS,
            ConnectorCapability.SYNC_OPPORTUNITIES,
            ConnectorCapability.CREATE_ACCOUNT,
            ConnectorCapability.CREATE_CONTACT,
            ConnectorCapability.CREATE_OPPORTUNITY,
            ConnectorCapability.UPDATE_ACCOUNT,
    ...
    ConnectorKey.SALESFORCE: ConnectorDefinition(
